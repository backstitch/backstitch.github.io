...
A topic is an automated stream of curated content collected from various **[sources]({% post_url 2015-05-19-sources %})** such as News Sites, Blogs, Social & Rich Media websites. 

A topic can be focused around a specific theme by combining like-minded **[sources]({% post_url 2015-05-19-sources %})** and making use of optional **[filters]({% post_url 2015-05-18-filters %})** to only show results that match particular keywords and phrases.
...
[Find topics I'm following](#NavigatingTopics)<br />
[Use a topic](#ViewingTopics)<br />
[Create a new topic](#CreatingTopics)<br />
[Make changes to one of my topics](#EditingTopics)<br />
[Follow other people's topics](#FollowingTopics)<br />

--

<a name='NavigatingTopics'></a>

[Top](#Top)<br />
## Navigating Topics

<div class="full zoomable"><img src="/images/topics/view_topic_0.png"></div>
...
<div class="full zoomable"><img src="/images/topics/view_topic_1.png"></div>
...
<div class="full zoomable"><img src="/images/topics/view_topic_4.png"></div>
...
<div class="full zoomable"><img src="/images/topics/view_topic_5.png"></div>
...
<div class="full zoomable"><img src="/images/topics/create_topic_0.png"></div>

**Give your topic a name:**

<div class="full zoomable"><img src="/images/topics/create_topic_1.png"></div>
...
For more strategies on adding sources **[check out this article]({% post_url 2015-05-19-sources %})**.

<div class="full zoomable"><img src="/images/topics/create_topic_2.png"></div>

#### Setting filters

Filters let you reduce the content from your sources to only include content that mentions specific keywords or phrases.

For more strategies on setting filters **[check out this article]({% post_url 2015-05-18-filters %})**.

<div class="full zoomable"><img src="/images/topics/create_topic_3.png"></div>

--

<a name='EditingTopics'></a>
...
<div class="full zoomable"><img src="/images/topics/edit_topic_0.png"></div>
...
<div class="full zoomable"><img src="/images/topics/edit_topic_1.png"></div>

***How do I include content from other sources?***

When editing a topic you will see a list of its included sources in the left-side column.  By clicking the **+ Add More** button you will launch the dialog to **[discover and add more sources]({% post_url 2015-05-19-sources %})**.

For more information on the ways to discover different sources of content **[check out this article]({% post_url 2015-05-19-sources %})**.
...
<div class="full zoomable"><img src="/images/topics/edit_topic_3.png"></div>

***How do I make my topic more specific?***

When editing a topic you will see a list of **[filters]({% post_url 2015-05-18-filters %})** that will tailor the topic to only include content matching specific keywords and phrases.

To learn more about the different types of filters available **[check out this article]({% post_url 2015-05-18-filters %})**.
 
<div class="full zoomable"><img src="/images/topics/edit_topic_4.png"></div>
...
<div class="full zoomable"><img src="/images/topics/discover_topics_0.png"></div>
...
<div class="full zoomable"><img src="/images/topics/discover_topics_1.png"></div>
...
<div class="full zoomable"><img src="/images/topics/discover_topics_2.png"></div>
